...
const APP_NAME = "Wildfire-Flood-Cascade";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Interactive honesty map for the wildfire-flood cascade (P121). Components verified; combined chain not studied as one system. No UTAC/CREP/AFET bridge.",
      },
